    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Carts",
                columns: new[] { "CartId", "CustomerId", "DeliveryDate", "ProductId", "Quantity", "Zipcode" },
                values: new object[] { 1, 201, new DateTime(2016, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), 101, 5, 641008 });
        }
